...
def create_user(
    ...
    Normal users should use POST /auth/register.
    """
...
def get_users(
    ...
    """Get all users (authenticated-only; tighten later for admins)."""
...
def update_user(
    ...
    """Update an existing user with partial data (self only)."""
    try:
...
def delete_user(
    ...
    """Delete a user by primary key (self only)."""
