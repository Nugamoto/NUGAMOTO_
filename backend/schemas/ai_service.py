...
from backend.schemas.ai_model_output import AIModelOutputRead
...
from backend.schemas.recipe import RecipeCreate, RecipeIngredientCreate, RecipeStepCreate, \
...
class PromptContext(BaseModel):
    ...
    def build_from_ids(
        ...
        from backend.schemas.food import FoodItemWithConversions
