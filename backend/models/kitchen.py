...
if TYPE_CHECKING:
    ...
    from backend.models.inventory import StorageLocation, InventoryItem
    from backend.models.shopping import ShoppingList
    from backend.models.device import Appliance, KitchenTool
